      ...
      <div className="w-full bg-amazon_blue text-white px-4 py-3 flex md:justify-between items-center gap-2 md:gap-4 lgl:gap-2 xl:gap-4">
        ...
        <div className="hidden lgl:inline-flex h-10 rounded-md flex-grow relative">
          <span
            ...
            className="w-15 h-full bg-gray-300 hover:bg-gray-400 border-2 cursor-pointer duration-400 text-md text-amazon_blue font-titleFont flex items-center justify-center rounded-tl-md rounded-bl-md"
          >
            Search{" "}
            <span>
        ...
        <div className="flex flex-col items-start justify-center headerHover">
          ...
          <p className="hidden md:inline-flex text-sm font-semibold mt-1 text-white">
